...
print('KELAS:A')
print('')
print('DOSEN PNGAMPU:AHMED MUZAKKI ASSERPIYOH,S.Kom,M.Kom')
print('')
...
class TicTacToe:
  def __init__(self):
    ...
    self.player_x = pygame.image.load('player_x_100.png')
    self.player_o = pygame.image.load('player_o_100.png')
    ...
    self.size_board = self.height_board, self.width_board = 300, 300
  ...
  def draw_info(self):
    ...
    if self.winner is not None:
      if self.winner != "Draw":
        ...
        info_winner = font.render('Seriiiiiiiiiiiiiii !!', True, self.color_game)
